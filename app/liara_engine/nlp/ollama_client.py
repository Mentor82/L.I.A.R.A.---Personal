...
def ask_liara(
    ...
    Args:
        ...
        custom_system_prompt: Überschreibt Default System Prompt (z.B. aus Config)
    ...
    # Verwende Custom Prompt falls vorhanden, sonst Default
    system_prompt = custom_system_prompt if custom_system_prompt else LIARA_SYSTEM_PROMPT
