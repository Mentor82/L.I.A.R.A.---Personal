    ...
    async def execute_create_event(self, details: Dict, user_id: int = 1) -> Dict:
        ...
        try:
            ...
            return {
                ...
                'message': f"✅ Termin '{event.title}' wurde erstellt!"
            }
    ...
    async def execute_create_task(self, details: Dict, user_id: int = 1) -> Dict:
        ...
        try:
            ...
            return {
                ...
                'message': f"✅ Aufgabe '{task.title}' wurde erstellt! {priority_emoji} Priorität: {task.priority}"
            }
    ...
    async def execute_create_note(self, details: Dict, user_id: int = 1) -> Dict:
        ...
        try:
            ...
            return {
                ...
                'note_id': note.id,
                'title': note.title,
                'message': f"✅ Notiz '{note.title}' wurde gespeichert!"
            }
