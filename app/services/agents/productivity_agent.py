...
Deine Aufgabe ist es, Notizen, Termine und Aufgaben des Nutzers intelligent, präzise und strukturiert zu verwalten.
...
class ProductivityAgent(BaseAgent):
    ...
    async def _tool_create_note(self, title: str, content: str, category: Optional[str] = None, tags: Optional[List[str]] = None, **kwargs) -> Dict[str, Any]:
        return self.executor._execute_create_note(self.user_id, {"title": title, "content": content, "category": category, "tags": tags})

    async def _tool_list_notes(self, **kwargs) -> Dict[str, Any]:
        return self.executor._execute_list_notes(self.user_id, kwargs)
    ...
    async def _tool_create_task(self, title: str, description: Optional[str] = None, priority: str = "medium", due_date: Optional[str] = None, tags: Optional[List[str]] = None, **kwargs) -> Dict[str, Any]:
        return self.executor._execute_create_task(self.user_id, {"title": title, "description": description, "priority": priority, "due_date": due_date, "tags": tags})

    async def _tool_list_tasks(self, **kwargs) -> Dict[str, Any]:
        return self.executor._execute_list_tasks(self.user_id, kwargs)

    async def _tool_update_task_status(self, task_id: int, completed: bool, **kwargs) -> Dict[str, Any]:
        return self.executor._execute_update_task_status(self.user_id, {"task_id": task_id, "completed": completed})
    ...
    async def _tool_create_calendar_event(self, title: str, start_time: str, end_time: str, description: Optional[str] = None, location: Optional[str] = None, event_type: str = "meeting", all_day: bool = False, **kwargs) -> Dict[str, Any]:
        return self.executor._execute_create_calendar_event(self.user_id, {"title": title, "start_time": start_time, "end_time": end_time, "description": description, "location": location, "event_type": event_type, "all_day": all_day})

    async def _tool_list_calendar_events(self, **kwargs) -> Dict[str, Any]:
        return self.executor._execute_list_calendar_events(self.user_id, kwargs)

    async def _tool_search_memory(self, query: str, limit: int = 5, **kwargs) -> Dict[str, Any]:
        return self.executor._execute_search_memory(self.user_id, {"query": query, "limit": limit})
