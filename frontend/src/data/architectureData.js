...
export const architectureNodes = [
  ...
  },
  {
    ...
    paths: [], views: ['chat'], x: 1240, y: 20,
  },
  {
    id: 'liara-core', title: 'LIARA (Core)', subtitle: 'Geplant: Anbindung via LiNeP', layer: 'Edge',
    status: 'planned', boundary: 'local',
    description: 'Das separate LIARA-Core-Projekt (Mentor82/L.I.A.R.A.) - geplante Anbindung an LIARA Personal über LiNeP/LiNeP-SL, statt beide Systeme komplett getrennt zu halten.',
    responsibilities: ['Ressourcen/Erkenntnisse mit LIARA Personal teilen (geplant)'],
    paths: [], views: ['chat'], x: 1500, y: 20,
  },
  {
...
export const architectureEdges = [
  ...
  { from: 'backend', to: 'coral-tpu', label: 'Bilderkennung (Vision-Offload)', kind: 'tool-call', views: ['chat'] },
  { from: 'hailo-npu', to: 'linep', label: 'geplant: Worker-Registrierung', kind: 'request', views: ['chat'] },
  { from: 'coral-tpu', to: 'linep', label: 'geplant: Worker-Registrierung', kind: 'request', views: ['chat'] },
  { from: 'linep', to: 'liara-core', label: 'geplant: LiNeP-Brücke', kind: 'request', views: ['chat'] },
