...
export const architectureNodes = [
  ...
  },
  {
    ...
    views: ['system', 'persistence'], x: 970, y: 480,
  },
  {
...
export const architectureEdges = [
  ...
  { from: 'backend', to: 'auth-privacy-consent', label: 'Consent-Gate', kind: 'validation', views: ['system'] },
  { from: 'backend', to: 'admin-functions', label: 'Admin-API', kind: 'data', views: ['system'] },
  ...
  { from: 'chat-streaming', to: 'context-memory', label: 'Kontext laden', kind: 'data', views: ['system', 'chat', 'persistence'] },
  ...
  { from: 'backend', to: 'persistence', label: 'Sessions/Nutzer', kind: 'mutation', views: ['system', 'persistence'] },
  { from: 'context-memory', to: 'persistence', label: 'Konzept-Graph', kind: 'mutation', views: ['system', 'persistence'] },
