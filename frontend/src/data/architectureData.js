...
export const architectureEdges = [
  ...
  { from: 'linep', to: 'liara-plugin', label: 'geplant: LiNeP-Transport', kind: 'request', views: ['chat'] },
  { from: 'liara-plugin', to: 'liara-core', label: 'geplant: Plugin-Anbindung', kind: 'request', views: ['chat'] },
